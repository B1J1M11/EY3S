...
import pywhatkit    # Pywhatkit pour envoyer un message via whatsapp
import playsound    # Playsound pour le son
    ...
    for (x, y, w, h) in faces:
        ...
        if w * h > 10000:
            ...
            if temps_actuel - derniere_capture >= 2:
                ...
                chemin_capture = os.path.join(dossier_capture, f'image_{num_visages_capture}.png')
                ...
                # Récupère le screen qui a été pris
                img = chemin_capture

                # Numéro à qui envoyer
                num = "+33649883494"

                # Envoie le screen avec le message
                pywhatkit.sendwhats_image(num, img, "Visage Détecté !")

                # Ajoute du delay sinon ça ne fonctionne pas mdrr why ?
                time.sleep(10)
